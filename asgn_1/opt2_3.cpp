...
void multiplyOPT2_3(int **arrayA, int **arrayB, int **arrayC){
...
int main(int argc,char* argv[]){
	...
	multiplyOPT2_3(arrayA, arrayB, arrayC);
    auto stop = high_resolution_clock::now();

    auto duration = duration_cast<microseconds>(stop - start); 
    cout <<fixed << duration.count() / power << endl;
    // cout << "Time taken by function - multiplyOPT2_3 : "<< duration.count() / power << " seconds" << endl;
